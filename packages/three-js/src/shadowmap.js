...
function createScene() {
  ...
  loader.load("src/fonts/helvetiker_bold.typeface.json", function (font) {
    const textGeo = new TextGeometry("JayJay.1024", {
      font: font,
  ...
  gltfloader.load("src/models/gltf/Flamingo.glb", function (gltf) {
    const mesh = gltf.scene.children[0];
    const clip = gltf.animations[0];
  ...
  gltfloader.load("src/models/gltf/Stork.glb", function (gltf) {
    const mesh = gltf.scene.children[0];
    const clip = gltf.animations[0];
  ...
  gltfloader.load("src/models/gltf/Parrot.glb", function (gltf) {
    const mesh = gltf.scene.children[0];
    const clip = gltf.animations[0];
